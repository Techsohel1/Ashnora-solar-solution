    ...
    <section className="bg-[#f5f5f5] py-20">
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <div className="text-center">
          <h2 className="text-xl md:text-4xl lg:text-5xl text-[#00539B]">
            <span className="font-bold">One-Stop Solar Solution</span>{" "}
            <span className="font-normal">For Your Business</span>
          </h2>

          <p className="max-w-5xl mx-auto mt-4 text-gray-700 md:text-xl leading-10">
            Ashnora Solar Solution offers complete end-to-end solutions from planning and design through to project construction and connection to the grid, as well as maintenance and care of the solar system.
          </p>
        </div>
...
export default OneStopForBusiness;